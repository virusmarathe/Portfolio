...
(function($ , undefined) {
	...
	Tree.prototype = {
			...
			this.options.dataSource.data($el.data(), function (items) {
				...
				$.each( items.data, function(index, value) {
					...
					if(value.type === "folder") {
						...
						if (value['ed'] == "0") thisname = "<b>"+thisname+"</b>";
						$entity.find('.tree-folder-name').html(thisname);
						...
						var thisname = value.name;
						if (value['ed'] == "0") thisname = "<b>"+thisname+"</b>";
						if ('cssClass' in value) {
							$entity.find('.tree-item-name').html(thisname + '   <i class="' + value['cssClass'] +'"></i>');
						} else {
							$entity.find('.tree-item-name').html(thisname);
						}
						$entity.data(value);
					}
		...
		selectFolder: function (el) {
			...
			if (data.length) {
                                this.$element.trigger('selectedfolder', {info: data});
                        }
		},
